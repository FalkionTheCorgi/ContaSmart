...
interface ItemDao {
    ...
    @Query("SELECT * FROM items WHERE vencimento = :vencimento")
    suspend fun getAllItemsByDeadlineTomorrow(vencimento: Int): List<ItemEntity>
    ...
    suspend fun updateItem(id: Int, name: String, price:Float, description: String, icon: String, vencimento: Int, person1: String, person2: String, person3: String, person4: String, priceOfPerson: Float, checkedPerson1: Boolean, checkedPerson2: Boolean, checkedPerson3: Boolean, checkedPerson4: Boolean)
